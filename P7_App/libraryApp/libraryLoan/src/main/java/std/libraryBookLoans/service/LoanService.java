...
public interface LoanService {
	 ...
	 * @param unitNumber
	 * @param unit
	 * @param daysOffList wait for a String[] containing DayOfWeek.toString(),can be
	 *                    null
	 * @param holidays    wait for a String[] containing LocalDate.toString(),can be
	 *                    null
	 *
	 * @apiNote
	 * -A loan period is defined by unitNumber x unit(ChronoUnit expect only
	 *          days/weeks/months/years)
