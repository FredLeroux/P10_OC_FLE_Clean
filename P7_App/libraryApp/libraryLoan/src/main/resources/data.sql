...
INSERT INTO libraryum.library_customers(
	...
	VALUES (1,'mail','$2b$12$63.SGPm6V9mibJ2LjWJGCu1hllDtFuU.Kn9KfrgtCaXrIkUj9S6VW',true,true,true,1,true,'_Q8O099vvq8x@@2f_1VYJiO888jj2r4I8p%0SIs44Cc1$2@9enER%MQ_F@@n'),
	(2,'newOne','$2a$10$XB.KGdug11ArpJenvjYFNOkFwLsvGno08GDk8GS/ixxI2rHzR4m.i',true,true,true,1,true,'%rzM%aiiR*_$7v*N114V$@@%!WQhMM$_C1u3KZZ67!!@!Yesq$?v@a6OOnnO');

INSERT INTO libraryum.library_building(id,
	 name)
...
INSERT INTO libraryum.library_books(
	...
	VALUES(1,'A_Kind','A_Book','A_author',true,3,null),
	...
	(10,'A_Kind','A_Book','A_author',true,4,null),
	...
	(48,'B_Kind','C_Book','B_author',true,2,null),
	...
	(55,'B_Kind','C_Book','B_author',false,1,null),
