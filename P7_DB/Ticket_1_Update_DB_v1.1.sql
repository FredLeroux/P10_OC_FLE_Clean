...
CREATE TABLE "LIBRARY"."libraryum"."library_book_reservation_number" (
                "id" INTEGER NOT NULL,
                "number_of_reservation" INTEGER NOT NULL,
                "library_book_fk" INTEGER NOT NULL,
                CONSTRAINT "library_book_reservation_number_pk" PRIMARY KEY ("id")
);
...
ALTER TABLE "LIBRARY"."libraryum"."library_book_reservation_number" ADD CONSTRAINT "library_books_library_book_researvation_number_fk"
